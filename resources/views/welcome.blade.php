...
<body>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="breaking-news">
                            <div id="breakingNewsTicker" class="ticker">
                                <ul>
                                    <li><a href="#"> Flavour Finder</a></li>
                                    <li><a href="#">Welcome to Flavour Finder.</a></li>
            ...
            <form action="#" method="post">
                <div class="row">
                    <div class="col-12 col-lg-3">
                        ...
                        <input type="search" id="ingredient" name="ingredient" placeholder="Search Receipies">
                    </div>
                    <div class="col-12 col-lg-3">
                        <label>Dietary Preferences</label>
                        <input type="search" id="dietry" name="dietry" placeholder="Search Receipies">
                    </div>

                    <div class="col-12 col-lg-3">
                        <label>Receipies</label>
                        <input type="search" id="recepi" name="recepi" placeholder="Search Receipies">
                    </div>
                    <div class="col-12 col-lg-3 text-right">
                        <button type="button" class="btn delicious-btn submitsearch mt-4">Search</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="col-12 h-100 d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        <script>
                            ...
                            target="_blank">Eighteen Pixels</a>
    ...
    <script>
        $('.submitsearch').on('click', function() {
            ...
            var dietry = $('#dietry').val();
            var recepi = $('#recepi').val();
            $(".errormsg").remove();
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    $.each(errors, function(key, value) {
                        $("input[name=" + key + "]").after("<p class='errormsg text-danger'>" + value + "</p>");
                    });
